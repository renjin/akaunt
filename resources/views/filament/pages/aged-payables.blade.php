    ...
    <x-filament::section>
        ...
        <table class="w-full text-sm">
            ...
            @forelse($rows as $vendor => $b)
                <tr class="border-b">
                    <td class="py-2">
                        <a href="{{ \App\Filament\Resources\Parties\PartyResource::getUrl('view', ['record' => $b['party']]) }}" class="font-medium text-primary-700 hover:underline">{{ $vendor }}</a>
                    </td>
        ...
        <p class="mt-2 text-xs text-gray-500">Includes unpaid bills dated on or before the as-of date, aged by due date.</p>
    </x-filament::section>
</x-filament-panels::page>
