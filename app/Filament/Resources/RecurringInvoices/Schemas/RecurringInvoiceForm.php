                ...
                Section::make()
                    ...
                    ->schema([
                        ...
                        Select::make('frequency')
                            ...
                            ->default('monthly')
                            ->required(),
                        TextInput::make('due_days')->label('Due in (days)')->numeric()->default(30)->required(),
                        DatePicker::make('next_run_date')->label('First invoice date')->required()->default(today()),
                        DatePicker::make('end_date')->label('Ends on (optional)'),
